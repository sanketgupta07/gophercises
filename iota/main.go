...
func main() {
	...
	// iota to initialise the int constant
	const (
		c1 = iota
		c2 = iota
		c3 = iota
	...
	const (
		c11 = iota
		c22 // iots will be assigned to c22 and c33 and we will get incremental values
		c33
	)
	fmt.Println(c11, c22, c33)

	const (
		EAST = iota // start with 0
		WEST
		NORTH
		SOUTH
	)
